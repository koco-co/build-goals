...
export const SKILLS = [
  ...
  {"name": "obsidian-learn-topic", "description": "将“从零系统学习某项技术、框架、语言、技术知识点或 GitHub 开源仓库”转化为经过当前资料核验、知识库前置审计、路线预览确认、Obsidian Base 进度管理、逐单元教学、实践测验和间隔复习的长期学习流程。用户表达开始或继续系统学习、制定学习路线、读懂 owner/repo 并完成真实最小 Patch、复习已学主题或维护学习路线时使用；支持模型直接调用和用户显式调用，不用于一次性概念问答、普通故障排查或未经授权的仓库贡献发布。", "modelInvocable": true, "userInvocable": true},
