 ...
 *
 * Registers the ten build-goals skills (shape-idea, health-check,
 * build-skill, build-plugin, build-prd, vibe-coding, build-readme,
 * build-agents-md, handoff, obsidian-learn-topic) on the host `skills`
 * registry. Summaries come from the generated
