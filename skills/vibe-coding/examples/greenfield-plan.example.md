...
本示例只展示 `docs/实施任务/功能域/<功能域>.md` 中的任务粒度，不提供可直接复制的项目事实。全局依赖图位于 `docs/实施任务/实施任务清单.md`。
...
- 需求/验收/行为样例：F-002、F-002-AC-01、F-002-AC-02、SAMPLE-ACCOUNT-001 至 SAMPLE-ACCOUNT-004
